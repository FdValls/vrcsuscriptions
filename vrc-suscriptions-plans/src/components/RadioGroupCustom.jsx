...
// showCategoryLabels: when true, displays category names above each radio (Infantiles / Juveniles / Plantel Superior)
    ...
    <div className="space-y-4 mt-[1rem]">
      ...
      >
        <div className="flex flex-col items-center">
          {showCategoryLabels && <p>Infantiles</p>}
          <Radio
            value="20000"
            classNames={{
              base: radioBaseClasses,
        ...
        <div className="flex flex-col items-center">
          {showCategoryLabels && <p>Juveniles</p>}
          <Radio
            value="40000"
            classNames={{
              base: radioBaseClasses,
        ...
        <div className="flex flex-col items-center">
          {showCategoryLabels && <p>Plantel Superior</p>}
          <Radio
            value="60000"
            classNames={{
              base: radioBaseClasses,
